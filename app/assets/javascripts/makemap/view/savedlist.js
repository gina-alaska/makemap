    ...
    '<tpl for=".">',
      '<div class="saved_wrap" id="savedMap_{id}">',
        ...
        '<div class="map_info">',
          ...
          '<div class="link"><a href="/mapsaves/{id}/download">Download</a> ({filesize:number("0.00")}MB)</div>',
          '<div class="info"><a href="#info" class="info">View full image information</a></div>',
